...
ss_poly_sp <- raster::rasterToPolygons(ss_rast_hcaf, dissolve = FALSE) # dissolve = FALSE means each raster cell is its own polygon. If dissolve was set to TRUE, it would combine contiguous cells that have the same value
